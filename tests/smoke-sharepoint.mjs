...
if (g.lists.length !== 8) errors.push(`Expected 8 lists (7 + library), got ${g.lists.length}`)
...
console.log('items:', ['QA Business Units', 'QA Projects', 'QA ITPs', 'QA Penetrations', 'QA Defects'].map((n) => `${n}=${count(n)}`).join(' '))
